...
// Creating data to draw chart for No. of trials registered in each year
	$data_points = array(
    array("label" => $data_keys_regdate_YYYY[0], "y" => $data_values_regdate_Frequency[0], "z" => $data_values_regdate_Frequency[0]),
		array("label" => $data_keys_regdate_YYYY[1], "y" => $data_values_regdate_Frequency[1], "z" => $data_values_regdate_Frequency[1]),
		array("label" => $data_keys_regdate_YYYY[2], "y" => $data_values_regdate_Frequency[2], "z" => $data_values_regdate_Frequency[2]),
		array("label" => $data_keys_regdate_YYYY[3], "y" => $data_values_regdate_Frequency[3], "z" => $data_values_regdate_Frequency[3]),
		array("label" => $data_keys_regdate_YYYY[4], "y" => $data_values_regdate_Frequency[4], "z" => $data_values_regdate_Frequency[4]),
		array("label" => $data_keys_regdate_YYYY[5], "y" => $data_values_regdate_Frequency[5], "z" => $data_values_regdate_Frequency[5]),
		array("label" => $data_keys_regdate_YYYY[6], "y" => $data_values_regdate_Frequency[6], "z" => $data_values_regdate_Frequency[6]),
		array("label" => $data_keys_regdate_YYYY[7], "y" => $data_values_regdate_Frequency[7], "z" => $data_values_regdate_Frequency[7]),
		array("label" => $data_keys_regdate_YYYY[8], "y" => $data_values_regdate_Frequency[8], "z" => $data_values_regdate_Frequency[8]),
		array("label" => $data_keys_regdate_YYYY[9], "y" => $data_values_regdate_Frequency[9], "z" => $data_values_regdate_Frequency[9]),
		array("label" => $data_keys_regdate_YYYY[10], "y" => $data_values_regdate_Frequency[10], "z" => $data_values_regdate_Frequency[10]),
		array("label" => $data_keys_regdate_YYYY[11], "y" => $data_values_regdate_Frequency[11], "z" => $data_values_regdate_Frequency[11]),
		array("label" => $data_keys_regdate_YYYY[12], "y" => $data_values_regdate_Frequency[12], "z" => $data_values_regdate_Frequency[12]),
		array("label" => $data_keys_regdate_YYYY[13], "y" => $data_values_regdate_Frequency[13], "z" => $data_values_regdate_Frequency[13])
	);
?>
